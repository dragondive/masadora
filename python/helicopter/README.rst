...
The workflow consists of two jobs, suitably named *fly-helicopter* and
*land-helicopter*, which perform the following functions:

1. **fly-helicopter**: Scrape, clean and transform the data into a JSON file.
2. **land-helicopter**: Generate the PlantUML diagram from the JSON file and commit it
   to the repository.
